...
$blankBoardString = $boardString;	
	$index= rand(1,9);
	//print "1st 3b3index  = " . $index . "!";
	for($i =1; $i<=9; $i++){ //first box level 1
		if($i == $index){
	...
	$index= rand(1,9);
		//print "2nd 3b3index  = " . $index . "!";
	for($i =1; $i<=9; $i++){ //second box level 1
		if($i == $index){
	...
	for($i =1; $i<=9; $i++){ //third box level 1
		if($i == $index){
	...
	for($i =1; $i<=9; $i++){ //fourth box level 1
		if($i == $index){
	...
	for($i =1; $i<=9; $i++){ //fifth box level 1
		if($i == $index){
	...
	for($i =1; $i<=9; $i++){ //sixth box level 1
		if($i == $index){
	...
	for($i =1; $i<=9; $i++){ //seventh box level 1
		if($i == $index){
	...
	for($i =1; $i<=9; $i++){ //eighthbox level 1
		if($i == $index){
