...
//----------------------------------------------level 2 start-------------------------------------------------------------------------------------
	...
	for($i =1; $i<=9; $i++){ //first box level 2
	...
	//print "2st 3b3index  = " . $index . "!";
	for($i =1; $i<=9; $i++){ //2nd box level 2
		if($i == $index1 || $i==$index2){
	...
	for($i =1; $i<=9; $i++){ //third box level 2
		if($i == $index1 || $i==$index2){
